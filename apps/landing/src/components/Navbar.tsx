          ...
          <div className="hidden md:flex items-center gap-8">
            {navLinks.map((link) => (
              <Link
                key={link.name}
                href={link.href}
                className="font-serif text-ink-700 hover:text-ink-900 transition-colors relative group"
              >
                {link.name}
            ...
            <button
              ...
              className="px-6 py-2 bg-ink-900 text-paper rounded-full font-serif hover:bg-ink-800 transition-colors flex items-center gap-2"
            >
              <User size={16} />
              로그인
            </button>
